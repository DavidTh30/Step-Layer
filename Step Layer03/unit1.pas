...
begin
  ...
  begin
    ...
    if OldCurrentLayer < FirstDevice then EventsList.Add('Device: '+OldCurrentLayer.ToString+ ' [Start (Init/Bank)]');
    if (OldCurrentLayer >= FirstDevice) and (OldCurrentLayer <= LastDevice) then EventsList.Add('Device: '+OldCurrentLayer.ToString);
    if OldCurrentLayer > LastDevice then EventsList.Add('Device: '+OldCurrentLayer.ToString+ ' [End (Wait/Virtual)]');
  end;
